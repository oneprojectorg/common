...
CREATE INDEX "decision_process_phases_instance_sort_idx" ON "decision_process_phases" ("process_instance_id","sort_order");--> statement-breakpoint
CREATE INDEX "decision_process_phases_profile_idx" ON "decision_process_phases" ("profile_id");--> statement-breakpoint
