...
CREATE INDEX "process_results_instance_date_idx" ON "decision_process_results" USING btree ("process_instance_id","created_at");--> statement-breakpoint
CREATE INDEX "process_results_success_date_idx" ON "decision_process_results" USING btree ("success","created_at");--> statement-breakpoint
