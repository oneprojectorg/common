...
ALTER TABLE "decision_process_phases" ADD CONSTRAINT "decision_process_phases_profile_id_profiles_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "profiles"("id") ON DELETE SET NULL ON UPDATE CASCADE;--> statement-breakpoint
