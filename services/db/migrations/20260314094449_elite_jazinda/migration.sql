...
ALTER TABLE "decision_transition_proposals" ADD CONSTRAINT "decision_transition_proposals_transition_history_id_proposal_id_unique" UNIQUE("transition_history_id","proposal_id");--> statement-breakpoint
