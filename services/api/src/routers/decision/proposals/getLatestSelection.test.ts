...
// Network gating matrix: getLatestSelectionForProposal sits on
// `commonAuthedProcedure`, which rejects no-JWT and anon-JWT at the auth
// middleware. Common-JWT owner is admitted and gets the (possibly null)
// selection back.
describeDecisionGating('getLatestSelectionForProposal', {
