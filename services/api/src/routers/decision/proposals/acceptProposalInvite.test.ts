...
// Network gating matrix: acceptProposalInvite sits on `commonAuthedProcedure`,
// which rejects no-JWT and anon-JWT at the auth middleware. Common-JWT
// invitee with a pending profileInvites row is admitted and becomes a
// profileUser on the proposal's profile.
describeDecisionGating('acceptProposalInvite', {
