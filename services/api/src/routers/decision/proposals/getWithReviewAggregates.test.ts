...
/**
 * Same rubric used by the list endpoint tests so per-criterion answers and
 * scores stay comparable across both suites.
 */
...
describe.concurrent('getWithReviewAggregates', () => {
  ...
  it('returns aggregates and submitted-only reviews[] for a proposal with mixed states', async ({
    ...
    // review row at all. All three should count toward assignmentsTotal but
