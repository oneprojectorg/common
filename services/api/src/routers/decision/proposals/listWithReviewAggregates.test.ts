...
// Network gating matrix: listWithReviewAggregates sits on
// `commonAuthedProcedure`, which rejects no-JWT and anon-JWT at the auth
// middleware. Common-JWT owner is admitted with admin access.
describeDecisionGating('listWithReviewAggregates', {
