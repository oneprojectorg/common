...
const alertVariants = cva(
  "group/alert relative grid w-full gap-0.5 rounded-lg border p-4 text-start text-base has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pe-20 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
