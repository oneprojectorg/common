...
function Textarea({
  ...
  return (
    <textarea
      ...
      data-slot="textarea"
      className={cn(
        // Free text: direction follows the content, and an empty box follows
        // the locale — see `Input` for why this beats `dir="auto"`, why an
        // explicit `dir` has to suppress it rather than sit alongside it, and
        // why the empty case needs `placeholder-shown` to opt back out.
        !dir &&
