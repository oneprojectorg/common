...
//
// `placeholder-shown` turns plaintext off while the field is empty. Plaintext
// runs UAX9 P2/P3, and P3 makes text with no strong character LTR rather than
// falling back to the element's direction — which put the caret at the left of
// an empty field on an Arabic page, opposite its own right-aligned placeholder.
