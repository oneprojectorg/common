...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    if (labelFormatter) {
      return (
        <div className={cn('font-strong', labelClassName)}>
    ...
    return <div className={cn('font-strong', labelClassName)}>{value}</div>;
  }, [
    label,
    labelFormatter,
    payload,
  ...
  return (
    <div
      className={cn(
        'grid min-w-32 items-start gap-1.5 rounded-md border border-border bg-background px-2.5 py-1.5 text-xs shadow-md',
        className,
      )}
    >
