...
// relational query builder and the durable cache are faked. The user-level
// resolver is faked too: it reads the same `profileUsers` table this test
// stubs, and its own filtering is covered by `platformAdmin.test.ts`.
