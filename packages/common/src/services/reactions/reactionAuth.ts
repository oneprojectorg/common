...
export type PostContext = {
  // Feed channels this post appears in (postsToProfiles). Used purely for
  // realtime channel registration, never for auth.
  associatedProfileIds: string[];
  parentPostId: string | null;
  // Pinned access gate from the post itself. Auth dispatches on this.
