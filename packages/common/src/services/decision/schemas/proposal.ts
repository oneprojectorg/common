...
/**
 * The proposal version a submitted review was written against. `isCurrent` is
 * false only when an older snapshot was returned, so a client labels the pane
 * "older version" from it.
 */
