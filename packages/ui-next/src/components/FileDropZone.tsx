  ...
  return (
    ...
    >
      <button
        ...
        disabled={isDisabled}
        className={cn(
          'flex flex-1 cursor-pointer flex-col items-center justify-center gap-6 rounded-lg border border-dashed border-input bg-muted/50 px-12 py-6 transition-colors duration-200 outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring',
      ...
      >
        <div className="flex size-20 items-center justify-center rounded-full bg-muted group-data-[drop-target]/dropzone:bg-primary/15">
          <LuFilePlus2 className="size-10 text-muted-foreground group-data-[drop-target]/dropzone:text-primary" />
        </div>
