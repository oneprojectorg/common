...
export const Default: Story = {
  render: () => (
    <div className="flex items-center gap-2 rounded border border-input bg-white p-2">
      <AutoSizeInputDemo
...
export const WithStyling: Story = {
  render: () => (
    <div className="flex items-center gap-2 rounded border border-input bg-accent px-3 py-2">
  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <div className="rounded border border-input bg-white p-2">
          <AutoSizeInputDemo
            initialValue=""
            minWidth={30}
      ...
      <div className="flex items-center gap-2">
        <span className="text-sm text-muted-foreground">minWidth=100:</span>
        <div className="rounded border border-input bg-white p-2">
          <AutoSizeInputDemo
            initialValue=""
            minWidth={100}
...
export const ConstrainedWidth: Story = {
  render: () => (
    <div className="flex max-w-64 items-center gap-2 rounded border border-input bg-accent px-2 py-1">
