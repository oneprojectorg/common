    ...
    <div className="flex gap-4">
      <Button
        onPress={() => {
          ...
          setTimeout(() => toast.success({ title: 'Toast 2', message: 'Second toast' }), 500);
          setTimeout(() => toast.error({ title: 'Toast 3', message: 'Third toast' }), 1000);
        }}
      >
