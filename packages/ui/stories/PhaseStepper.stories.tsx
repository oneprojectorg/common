...
export const InteractivePhases: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive phases show a play icon on hover and trigger onTransition when clicked. Non-interactive phases remain static.',
      },
    },
  },
};
...
export const MixedInteractivity: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Only specific phases are interactive — hover over Development and Release to see the play icon',
      },
    },
  },
};
