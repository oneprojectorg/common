  ...
  <div className="w-full max-w-md space-y-8">
    <div className="space-y-4">
      ...
      <MediaDisplay
        ...
        size={2048000}
      >
        <div className="aspect-video bg-neutral-gray1 rounded-t-lg flex items-center justify-center">
...
export const PDFDocument = {
  args: {
    ...
    description: "Complete technical documentation for the API including endpoints, authentication, and usage examples.",
