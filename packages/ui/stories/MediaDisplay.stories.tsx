  ...
  <div className="w-full max-w-md space-y-8">
    <div className="space-y-4">
      ...
      <MediaDisplay
        ...
        size={2048000}
      >
        <div className="bg-neutral-gray1 flex aspect-video items-center justify-center rounded-t-lg">
          <div className="text-center">
            <div className="mb-2 text-6xl">📄</div>
            <div className="text-neutral-gray4 text-sm">PDF Preview</div>
          </div>
        </div>
      </MediaDisplay>
    </div>
    ...
    <div className="space-y-4">
      ...
      >
        <div className="bg-neutral-gray1 flex aspect-video items-center justify-center rounded-t-lg">
          <div className="text-center">
            <div className="mb-2 text-6xl">🔗</div>
            <div className="text-neutral-gray4 text-sm">Web Preview</div>
          </div>
        </div>
      </MediaDisplay>
    </div>
  ...
  args: {
    ...
    children: (
      <div className="bg-neutral-gray1 flex aspect-video items-center justify-center rounded-t-lg">
        <div className="text-center">
          <div className="mb-2 text-6xl">📋</div>
          <div className="text-neutral-gray4 text-sm">PDF Document</div>
        </div>
      </div>
    ),
  },
  ...
  args: {
    ...
    children: (
      <div className="bg-neutral-gray1 flex aspect-video items-center justify-center rounded-t-lg">
        <div className="text-center">
          <div className="mb-2 text-6xl">🌐</div>
          <div className="text-neutral-gray4 text-sm">Website Preview</div>
        </div>
      </div>
    ),
  },
  ...
  args: {
    ...
    children: (
      <div className="bg-neutral-gray1 flex aspect-video items-center justify-center rounded-t-lg">
        <div className="text-center">
          <div className="mb-2 text-6xl">📄</div>
          <div className="text-neutral-gray4 text-sm">Minimal Content</div>
        </div>
      </div>
    ),
  },
  ...
  args: {
    ...
    children: (
      <div className="bg-neutral-gray1 flex aspect-video items-center justify-center rounded-t-lg">
        <div className="text-center">
          <div className="mb-2 text-6xl">📝</div>
          <div className="text-neutral-gray4 text-sm">Long Description</div>
        </div>
      </div>
    ),
  },
