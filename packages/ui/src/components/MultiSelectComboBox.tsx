  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        <div
          className="border-offWhite hover:border-neutral-gray2 flex min-h-10 w-full cursor-pointer flex-wrap items-center rounded-md border bg-white px-3 py-2 text-base"
          onClick={() => {
        ...
        >
          <div className="relative flex w-full flex-wrap items-center gap-1">
            <input
              ref={inputRef}
              type="text"
              className="outline-hidden group-data-[invalid=true]:outline-functional-red placeholder:text-neutral-gray4 ml-1 min-w-[40px] flex-1 border-none bg-transparent pr-7 text-base group-data-[invalid=true]:outline-1"
              value={inputValue}
              ...
              style={{ minWidth: 40 }}
            />
            <span className="text-neutral-charcoal pointer-events-none absolute right-2 top-1/2 -translate-y-1/2">
              {isLoading ? (
          ...
          <div className="mt-1 flex flex-wrap gap-2">
            {selectedOptions.map((option) => (
              <div
                ...
                className="text-charcoal flex items-center rounded bg-black/5 p-2"
              >
        ...
        {isOpen && filteredItems.length > 0 && (
          <div className="border-neutral-gray1 absolute z-10 mt-1 w-full rounded-md border bg-white shadow-lg">
                ...
                return (
                  <li
                    ...
                    className={`flex flex-col items-start px-3 py-2 text-base ${
                      isParent
                        ? 'text-neutral-gray4 cursor-default py-2 pt-2 text-sm' // parent styling
                        : `hover:bg-neutral-gray1 cursor-pointer ${
                  ...
                  >
                    <span
                      className={isParent ? 'text-neutral-gray4 text-sm' : ''}
                    >
                      {option.label}
                    </span>
                    {showDefinitions && option.definition && !isParent ? (
                      <span className="text-neutral-charcoal overflow-hidden text-ellipsis text-wrap text-left text-sm">
                        {option.definition}
                      </span>
                    ) : null}
                  </li>
