...
const tabProps = tv({
  base: 'flex h-8 cursor-default items-center text-nowrap px-2 py-3 text-base font-normal text-neutral-gray4 outline-none transition forced-color-adjust-none focus-visible:bg-offWhite sm:h-auto sm:bg-transparent',
  variants: {
    variant: {
      default: '',
