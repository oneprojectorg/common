...
export function inputGroupStyles(props: React.ComponentProps<'div'>) {
  return cn(
    ...
    'has-[[data-slot=input-group-control]:focus-within]:border-ring has-[[data-slot=input-group-control]:focus-within]:ring-[3px] has-[[data-slot=input-group-control]:focus-within]:ring-ring/50',
