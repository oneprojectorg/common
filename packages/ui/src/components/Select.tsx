...
const selectStyles = tv({
  base: 'flex h-10 min-w-0 flex-row justify-between rounded-md border border-neutral-gray1 p-3 text-base text-neutral-black outline outline-0 placeholder:text-neutral-gray4 active:border-neutral-gray4 active:outline hover:border-neutral-gray2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-data-blue disabled:border-neutral-gray2',
  variants: {
    isDisabled: {
