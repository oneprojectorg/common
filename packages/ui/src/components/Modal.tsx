...
const modalStyles = tv({
  base: 'inset-shadow isolate z-[999999] max-h-full w-full max-w-md rounded-2xl border border-neutral-200 bg-neutral-100/95 bg-clip-padding text-left align-middle font-sans text-neutral-700 backdrop-blur-lg backdrop-brightness-50 backdrop-saturate-50 entering:duration-500 entering:ease-out entering:animate-in entering:fade-in exiting:duration-500 exiting:ease-in exiting:animate-out exiting:fade-out',
});
