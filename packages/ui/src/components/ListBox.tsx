    ...
    <>
      ...
      <AriaListBox
        ...
        className={composeTailwindRenderProps(
          props.className,
          'border-neutral-gray1 rounded border p-1 outline-0',
        )}
      >
        {children}
      </AriaListBox>
  ...
  return (
    ...
    >
      {composeRenderProps(props.children, (children, { isSelected }) => (
        <>
          <span className="group-hover:bgt-neutral-gray1 text-neutral-black flex h-full flex-1 items-center gap-2 truncate font-normal">
            {children}
          </span>
