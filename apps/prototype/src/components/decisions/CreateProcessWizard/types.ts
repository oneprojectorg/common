...
export interface ProcessDraft {
  ...
  steward: string;
  /**
   * Kept so the created phases have an audience, but no longer asked: submissions
   * open to the public, and each phase page changes its own access. Deciding it
   * here meant deciding it before the phase had a form or a window.
   */
  audience: Audience;
