...
export const LoginPanel = () => {
  ...
  return (
    <div className="min-w-xs z-[999999] max-h-full w-auto rounded-2xl border-offWhite bg-white bg-clip-padding px-4 py-8 font-sans text-neutral-700 xs:w-96 sm:border-0">
