...
function PostDetailPageSkeleton() {
  return (
    <div className="flex min-h-screen flex-col bg-white">
      {/* Header skeleton */}
      <div className="border-neutral-gray1 grid grid-cols-[auto_1fr_auto] items-center border-b bg-white p-2 px-6 sm:grid-cols-3 md:py-3">
      ...
      <div className="mx-auto flex w-full max-w-xl flex-1 flex-col p-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="border-neutral-gray1 border-y">
