...
/**
 * Client tree for the proposal editor.
 *
...
export function EditProposalClient() {
  // On a client-side navigation the server loader in page.tsx never runs, so
  // the suspense queries below can still throw NOT_FOUND (missing/malformed
  // proposal) or FORBIDDEN (no access); translate those to accurate 404/403
  // pages instead of letting them bubble to error.tsx as a 500.
  return (
