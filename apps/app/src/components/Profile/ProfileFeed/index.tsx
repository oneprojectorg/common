        ...
        {posts.length > 0 ? (
          posts.map((postToOrg) => (
            <HorizontalListItem
              ...
              className="max-w-96 p-3 first:ml-4 last:mr-4 w-11/12 shrink-0 snap-start rounded border"
            >
              <PostItem
                post={postToOrg.post}
          ...
          <HorizontalListItem className="max-w-96 p-3 first:ml-4 last:mr-4 w-11/12 shrink-0 snap-start rounded border">
            <EmptyPostsState />
          </HorizontalListItem>
        )}
        {shouldShowTrigger && (
