...
export const ToSContent = () => {
  return (
    <div className="relative flex w-full flex-col gap-8 sm:pb-20">
      ...
      <FormalSection>
        <Header3 className="font-serif">1. Introduction and Acceptance</Header3>
        <p>
          ...
          the Services. By using the Services or clicking to accept or agree to
          the Terms of Service when this option is made available to you, you
          agree to be legally bound by these Terms of Service. If you do not
          agree to these Terms of Service, you are not permitted to access or
          use the Services.
        </p>
        <p>
        ...
        <p>
          ...
          RIGHTS AND OBLIGATIONS, AS WELL AS VARIOUS CONDITIONS, LIMITATIONS,
          AND EXCLUSIONS, INCLUDING LIMITATIONS OF LIABILITY IN SECTION 18 AND
          AN ARBITRATION CLAUSE AND CLASS ACTION WAIVER IN SECTION 26.
        </p>
        <p>
          BY AGREEING TO THESE TERMS OF SERVICE, YOU AGREE TO RESOLVE ALL
          DISPUTES THROUGH BINDING ARBITRATION ON AN INDIVIDUAL BASIS, WHICH
      ...
      <FormalSection>
        ...
        <p>
          ...
          discretion by posting notice of such changes on the Website or
          otherwise by providing you with adequate notice, such as by emailing
          you at an email address you provide to us. You can review the most
          current version of these Terms of Service at any time on this page. It
          is your responsibility to check this page periodically for changes.
          All changes are effective immediately when we post notice of them, and
          apply to all access to and use of the Services after that time. Your
          continued use of the Services following the posting of the notice of
          the revised Terms of Service means that you accept and agree to the
          changes. If the changes are not acceptable to you, your only recourse
      ...
      <FormalSection>
        <Header3 className="font-serif">4. Our Mission</Header3>
        <p>
          One Project is focused on connecting people, organizations, and
          resources to coordinate and scale a global democratic economy. We ask
          that all users of our Services, including the Platform, embrace these
        ...
        <p>
          ...
          Agreements): Recognize and respect the expertise, leadership, and
          lived experiences of communities most impacted by economic inequality.
          Actively make space for their voices, defer to their guidance on
          issues affecting them directly, and acknowledge their essential role
          in developing meaningful solutions.
        </p>
        <p>
          Share from Your Own Experiences (adopted from New Economy Coalition
          Agreements): Be sure to share information and perspectives from your
          experiences rather than making assumptions about or speaking on behalf
          of others. When sharing information, clearly distinguish among
          personal knowledge, organizational position/perspective, and
          third-party information.
        </p>
        <p>
          These principles are included in our code of conduct which you can
          find here.
        </p>
      </FormalSection>
      ...
      <FormalSection>
        <Header3 className="font-serif">6. The Code</Header3>
        <p>
          ...
          activities into the protected commons, whenever possible. The code
          developed and owned by One Project on which the Platform runs (the
          "Code") is made available to you under the Apache 2.0 license,
          modified by the Commons Clause and certain Ethical Provisions (this
          link is an example of the types of ethical provisions that might be
          included) (together, the "Code License"). Please review these license
          terms carefully before using or contributing to the Platform. We
          reserve the right to change the terms of this license grant at any
          time, in our sole discretion but always consistent with our mission,
          by posting notice of such changes on the Platform. For clarity, any
          content or materials posted on the Platform, by One Project or another
          user, is not included in the Code and will be subject to the more
          limited license below in Section 6.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">7. License</Header3>
        <p>
          ...
          functionalities, or third-party components, One Project grants you a
          non-exclusive, revocable, non-transferable, non-assignable license
          (without right of sublicense) to use the Services other than the Code
          as they may be provided to you, solely for your internal,
          non-commercial use. Other than as expressly granted in these Terms of
          Service, no right, title, or interest in or to the Services or any
          content on the Services is transferred to you, and all rights not
          expressly granted are reserved by One Project.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">8. System Requirements</Header3>
        <p>
          ...
          Use of the Services involves transmission of data to and from your
          device. One Project excludes any and all responsibility for the data
          transmission process. The data transmission process (including its
          speed, connectivity, and/or quality) is administered by and is the
          responsibility of your internet service provider.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">9. Use Restrictions</Header3>
        <p>
          ...
          United States copyright and patent laws and international treaty
          provisions. While the Code is subject only to the limitations
          contained in the Code License described above, all other Services
        ...
        <p>
          ...
          part of it without the prior written consent of One Project.
        </p>
        <p>
          You may not assign these Terms of Service or any of the rights or
          licenses granted under these Terms of Service or rent, lease, or lend
          the Services or any part of it to any person or entity. Any attempted
          sublicense, transfer, or assignment in violation of these Terms of
          Service is void.
        </p>
        <p>
          You acknowledge that the Services contain proprietary trade secrets of
          One Project and its suppliers. You agree not to decompile,
          ...
          techniques, or algorithms of the Services or any part of the Services
          by any means whatsoever and you agree not to encourage or assist any
          other person to do so, except to the extent the foregoing restriction
          is prohibited by applicable Law, and you agree not to interfere with
          or circumvent the security of the Services, including without
          limitation by accessing or attempting to access any profile, device or
          server that you are not authorized to access.
        </p>
        <p>
          You may not use any robot, spider, or other automatic device, process,
          or other means to crawl, scrape, or otherwise access the Services, or
          use any means to reproduce or alter the navigational structure or
          presentation of the Services, for any purpose, including monitoring or
          copying any of the material on the Services or training any artificial
          intelligence model, without our prior written consent.
        </p>
        <p>
          You may not use or copy the Services in order to spam, phish, pharm,
          pretext, or engage in similar acts, including without limitation to
          impersonate or attempt to impersonate One Project, a One Project
          employee, another user, or any other person.
        </p>
        <p>
          You may not introduce into the Services or use the Services to store
          or transmit any viruses, Trojan horses, worms, logic bombs, spyware,
          or other type of malicious code that will or may be used in any way
          that will affect the functionality or operation of the Services or of
          any related website, other websites, hardware, software, or equipment.
        </p>
        <p>
          You may not remove, delete, alter, or obscure any trademarks or any
        ...
        <p>
          ...
          product or service or to conduct benchmarking tests or other analysis
          comparing the Services with a non-One Project product or service.
        </p>
        <p>
          You may not interfere, circumvent or attempt to interfere with or
          circumvent the security, integrity, or performance of the Services in
          any way.
        </p>
        <p>
          ...
          provincial statutes, regulations, rules, and orders, all international
          treaties, and all other laws (each, a "Law") and only within the
          express scope of the license granted in these Terms of Service. You
          agree not to use the Services to infringe upon or violate our
          intellectual property rights or those of others or to store or
          transmit infringing, libelous, or otherwise unlawful or tortious
          material or material in violation of third-party privacy rights.
        </p>
        <p>
        ...
        <p>
          You agree not to use the Services to engage in any other conduct that
          restricts or inhibits anyone's use or enjoyment of the Services, or
          which may harm One Project or users of the Services, or expose them to
          liability.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">10. Ownership</Header3>
        <p>
          ...
          documentation, or any intellectual property rights therein. One
          Project and its licensors retain all right, title, and interest in and
          to the Services (including any changes, modifications, or corrections
          thereto), any related documentation, and any intellectual property
          rights therein.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">11. Trademarks</Header3>
        <p>
          ...
          trademarks or registered trademarks of One Project or its licensors or
          licensees. Ownership of these trademarks, names, and logos, and the
          goodwill associated with them, remains with One Project or those other
          entities, and you are not authorized to use any such trademarks,
          names, and logos.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">12. Your Content</Header3>
        <p>
          ...
          that you share with or upload to the Platform (collectively, "Your
          Content"). You further represent and warrant that Your Content does
          not and will not infringe, misappropriate, or otherwise violate any
          intellectual property rights of any third party or any applicable Law.
          By accessing the Services, you grant One Project, our third-party
          service providers, and our other users a worldwide, perpetual,
          transferable, sub-licensable, royalty-free right and license to use,
          host, copy, transmit, store, display, perform, edit, publish,
          translate, modify, reformat, incorporate into other works, advertise,
          distribute and otherwise make available to the general public Your
          Content.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">13. Prohibited Content</Header3>
        <p>
        ...
        <p>Is intended to harass, upset, embarrass, alarm, or annoy others.</p>
        <p>
          Is Encouraging, depicting, facilitating, or participating in any
          harmful activities that may endanger platform users and their
          networks.
        </p>
        <p>
          Is sharing false or misleading information that could damage someone's
          reputation.
        </p>
        <p>
          Is sharing the personal information of others without their consent.
        </p>
        <p>
          Is engaging in commercial activities (including, without limitation,
          sales, competitions, promotions, and advertising).
        </p>
        <p>
          For more information about prohibited behavior. See our Code of
          Conduct here.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">14. Copyright Infringement</Header3>
        <p>
          ...
          rights have been otherwise violated, on our Platform or otherwise
          within our Services, you should notify One Project of your
          infringement claim in accordance with the procedure set forth below.
          Please note that we may send a copy of any legal notice we receive to
          the person or entity claimed to be infringing.
        </p>
        <p>
        ...
        <p>
          ...
          located on our Platform or otherwise within our Services, with enough
          detail that we may find it on our Services;
        </p>
        ...
        <p>
          ...
          receipt of the counter-notice, in our sole discretion.
        </p>
        <p>
      ...
      <FormalSection>
        <Header3 className="font-serif">15. Limited Liability</Header3>
        <p>
          ...
          appropriateness. We are not responsible for, and we do not endorse,
          any of Your Content or content posted by other users, and for the
          avoidance of doubt, we specifically disclaim any liability related to
          Your Content. We do not undertake any responsibility to store or back
          up Your Content. We are not responsible or liable for any error or
          loss related to Your Content or the export of Your Content from the
          Services. You are responsible for implementing sufficient procedures
          ...
          a means external to our Services for any reconstruction of any lost
          information, content and other materials.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">16. Payment</Header3>
        <p>
          ...
          the Services at any time. We will notify you of any fees or changes
          relating to costs of using the Services by posting notice of such
          changes in the Platform or otherwise by providing you with adequate
          notice, and you will have the opportunity to cease your use of the
          Services if you do not agree to any such changes. If at any time, One
          Project offers a functionality that permits monetary transactions
          through the Platform or a third-party service, additional terms may
          apply.
        </p>
      </FormalSection>
      ...
      <FormalSection>
        <Header3 className="font-serif">
          17. Limitations Regarding the Services
        </Header3>
        <p>
          ...
          Services or any features or content of the Services at any time with
          or without notice to you, or (b) may change the form and nature of any
          aspect of the Services at any time with or without notice to you. One
          Project will use reasonable efforts to provide a reasonable notice
          period in advance of any changes that will materially affect your use
          of the Services. It is your responsibility to regularly back-up Your
          Content and any material related to your account or use of the
          Services.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">18. Storage</Header3>
        <p>
          ...
          account. One Project will have no liability whatsoever to you or any
          third party for any failure of the Services to store any such
          information on its own or any other equipment or system.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">19. Disclaimer of Warranty</Header3>
        <p>
          ...
          IMPLIED, STATUTORY, ARISING THROUGH COURSE OF PERFORMANCE, OR
          OTHERWISE. YOUR USE OF THE SERVICES IS AT YOUR OWN RISK. TO THE
          FULLEST EXTENT PERMITTED BY LAW, WE HEREBY DISCLAIM ALL SUCH
          WARRANTIES, INCLUDING WITHOUT LIMITATION ALL IMPLIED OR STATUTORY
          WARRANTIES OF TITLE, MERCHANTABILITY, QUIET ENJOYMENT,
          NON-INFRINGEMENT, AND FITNESS FOR PARTICULAR PURPOSE. WE DO NOT
          WARRANT THAT: (A) THE SERVICES WILL BE ACCURATE, RELIABLE, COMPLETE,
          TIMELY, OR ERROR-FREE; (B) DEFECTS OR ERRORS WILL BE CORRECTED; (C)
          ACCESS TO THE SERVICES WILL BE UNINTERRUPTED OR SECURE; (D) OUR
          SERVICES OR ANY MATERIALS DOWNLOADED FROM THE SERVICES ARE SECURE OR
          FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS; OR (E) THE SERVICES WILL
          OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS. WE DISCLAIM ALL EQUITABLE
          INDEMNITIES. WITHOUT LIMITING THE FOREGOING, WE WILL NOT BE LIABLE FOR
          ANY LOSS OR DAMAGE CAUSED BY A DENIAL-OF-SERVICE ATTACK, VIRUSES, OR
          OTHER TECHNOLOGICALLY HARMFUL MATERIAL THAT MAY INFECT YOUR EQUIPMENT,
          DEVICE, OR OTHER PROPRIETARY MATERIAL DUE TO YOUR USE OF THE SERVICES,
          OR TO YOUR DOWNLOADING OF ANY MATERIAL OR DATA POSTED ON THE SERVICES,
          OR TO ANY OTHER WEBSITE, DATA, OR MATERIAL LINKED TO OR ACCESSIBLE
          FROM THE SERVICES.YOU ACKNOWLEDGE THAT THE PROVISIONS OF THIS SECTION
          ARE A MATERIAL INDUCEMENT AND CONSIDERATION TO ONE PROJECT TO GRANT
          THE LICENSE CONTAINED IN THESE TERMS OF SERVICE AND TO PROVIDE YOU
          WITH ACCESS TO THE SERVICES.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">20. Limitation of Liability</Header3>
        <p>
          ...
          OR OUR OR THEIR RESPECTIVE LICENSORS, SERVICE PROVIDERS, SUPPLIERS,
          EMPLOYEES, AGENTS, CONTRACTORS, OFFICERS, OR DIRECTORS (COLLECTIVELY,
          THE "ONE PROJECT PARTIES") BE LIABLE FOR ANY DIRECT, INDIRECT,
          SPECIAL, CONSEQUENTIAL, INCIDENTAL, OR PUNITIVE DAMAGES WHATSOEVER
          (INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS OF BUSINESS PROFITS,
          BUSINESS INTERRUPTIONS, LOSS OR CORRUPTION OF DATA, DAMAGE TO ANY
          COMPUTER OR DEVICE, OR OTHER PECUNIARY LOSS) ARISING OUT OF THESE
          TERMS OF SERVICE, YOUR USE OF OR INABILITY TO USE THE SERVICES, OR ANY
          ACTIVITIES WITH WHICH YOU USE THE SERVICES, EVEN IF SUCH ONE PROJECT
          PARTY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. SHOULD ANY
          ONE PROJECT PARTY BE FOUND TO BE LIABLE TO YOU OR ANY THIRD PARTY
      ...
      <FormalSection>
        <Header3 className="font-serif">21. Exclusions and Local Laws</Header3>
        <p>
          Some jurisdictions do not allow the exclusion of certain warranties or
          the limitation or exclusion of liability for incidental or
          consequential damages. Furthermore, mandatory local consumer
          protection Laws, which these Terms of Service do not replace or
          exclude, may offer you legal rights and remedies in addition to the
          rights and remedies provided to you under these Terms of Service.
      ...
      <FormalSection>
        <Header3 className="font-serif">22. Indemnification</Header3>
        <p>
          ...
          any claims, demands, actions, suits, liabilities, damages, losses,
          costs, penalties, fines, and settlements (including reasonable
          attorneys' and experts' fees) arising out of or relating to: (a) your
          violation of these Terms of Service; (b) your use of, or activities in
      ...
      <FormalSection>
        <Header3 className="font-serif">23. Termination</Header3>
        <p>
      ...
      <FormalSection>
        <Header3 className="font-serif">24. Export Laws</Header3>
        <p>
          ...
          technical data. You agree that you will not export or re-export the
          Services or any part of them in any form in violation of the Laws of
      ...
      <FormalSection>
        ...
        <p>
          ...
          makes no representation that any aspect of the Services is or will be
          available or appropriate for use in any particular location. To the
          extent you choose to use or access the Services outside the United
          States, you do so at your own initiative and you are responsible for
      ...
      <FormalSection>
        <Header3 className="font-serif">26. Miscellaneous</Header3>
        <p>
          ...
          communications or documents concerning, the subject matter of these
          Terms of Service.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">27. Governing Law</Header3>
        <p>
          ...
          (notwithstanding your place of residency), except that the dispute
          resolution clause below shall be enforced and interpreted exclusively
          in accordance with applicable U.S. federal law, including the U.S.
          Federal Arbitration Act. These Terms of Service will not be governed
          by the U.N. Convention on Contracts for the International Sale of
          Goods. If any provision of these Terms of Service is found to be
          invalid or unenforceable, it will be enforced to the extent
          permissible and the remainder of these Terms of Service will remain in
          full force and effect. Failure by One Project to prosecute any right
          with respect to a default hereunder will not constitute a waiver by
          One Project of the right to enforce rights with respect to the same or
          any other breach.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">28. Dispute Resolution</Header3>
        <p>
          ...
          RESPECT TO A CLAIM. OTHER RIGHTS THAT YOU WOULD HAVE IF YOU WENT TO
          COURT MAY ALSO BE UNAVAILABLE OR MAY BE LIMITED IN ARBITRATION.
        </p>
        <p>
          You hereby agree that any claim or dispute between you and One
          Project, whether brought by you or by One Project, arising out of or
          relating in any way to these Terms of Service or your use of the
          Services must be resolved through final, binding arbitration, except
          that either you or we may assert claims in small claims court if those
          claims qualify under applicable Law. In addition, either you or we
          have the option to bring claims in court to enjoin infringement or
          other violation of intellectual property rights without seeking
          damages. This arbitration obligation applies regardless of whether the
          claim or dispute involves a warranty, tort, fraud, misrepresentation,
          product liability, negligence, violation of a statute, or any other
          legal theory. Unless you opt-out of arbitration as set forth below,
          ...
          interpretation, applicability, scope, unconscionability,
          arbitrability, enforceability or formation of this arbitration
          provision, including any claim that all or any part of this
          arbitration provision is void or voidable. There is no judge or jury
          in arbitration, the arbitration will be subject to different rules
          than the rules that would apply in court, and court review of
          arbitration awards is very limited. However, an arbitrator can award
          on an individual basis the same damages and other relief as a court
          (including injunctive and declaratory relief and statutory damages),
          and must follow these Terms of Service, as a court would.
        </p>
        <p>
          All arbitrations under these Terms of Service shall be conducted on an
          individual, and not on a class-wide, basis, and an arbitrator shall
          have no authority to certify a class or award class-wide relief. The
          arbitrator is authorized only to award relief on behalf of the
          individual parties and only to their extent of their individual
          claims. You acknowledge and agree that unless otherwise agreed in
          writing by you and One Project, with regard to any claims hereunder,
          you may not seek to, and an arbitrator or court may not, join or
          consolidate your claims with any other similar claims. You agree you
          will not proceed in any court or arbitration proceedings as a
          representative of others (including in the capacity of a private
          attorney general), join in any court or arbitration proceedings
          brought by any other person, and understand that you may not be
        ...
        <p>
          ...
          address stated in Section 27 below. If a party's claim is not resolved
        ...
        <p>
          ...
          stated above, except that the interpretation and enforcement of this
          arbitration provision shall be governed by the Federal Arbitration
          Act. The arbitrator shall be empowered to award the prevailing party
        ...
        <p>
          YOU AND WE SPECIFICALLY ACKNOWLEDGE AND AGREE THAT EACH OF US
          EXPRESSLY WAIVES THE RIGHT TO BRING A LAWSUIT IN COURT BASED ON ANY
          CLAIMS OR DISPUTES DESCRIBED IN SECTIONS 26(A) AND (B) ABOVE, AND THAT
          YOU AND WE EXPRESSLY WAIVE THE RIGHT TO HAVE SUCH CLAIMS OR DISPUTES
          RESOLVED BY A JUDGE OR JURY OR TO PARTICIPATE IN A CLASS ACTION. AS
          SUCH, YOU AND WE HEREBY AGREE TO RESOLVE ANY AND ALL SUCH CLAIMS
          DESCRIBED ABOVE VIA INDIVIDUAL BINDING ARBITRATION PER THE TERMS AND
          CONDITIONS SET FORTH IN THIS SECTION 26(A)-(E).
        </p>
        <p>
          You may opt-out of Sections 26(a)-(e) by sending a notice ("Rejection
          ...
          this Section 26. If you opt out of a subsequent revision, you will
          remain bound by the prior version of this Section unless you
          previously opted out of that version. You must mail the Rejection
          Notice by certified mail return receipt requested or messenger service
          (e.g. Federal Express) to the address stated in Section 27 below. In
          the event of any dispute concerning whether you provided a Rejection
          Notice within sixty (60) days, you must provide a signed receipt
          confirming One Project received the Rejection Notice within sixty (60)
          days. You may opt out of these Terms of Service in their entirety by
          not using the Services.
        </p>
        <p>
          To the extent that a dispute is not subject to arbitration under this
          Section 26, such dispute must be resolved exclusively through an
          action brought in the appropriate state or federal court located in
          San Francisco, California and both parties irrevocably consent to the
          jurisdiction and venue of such courts for the adjudication of any
          non-arbitrable claims and waive any objection to such courts on any
          basis, including without limitation inconvenience of the forum. You
          and we expressly waive the right to a jury trial in connection with
          any such lawsuit and agree that no such lawsuit can be brought as a
          class action or other representative action.
        </p>
      </FormalSection>

      <FormalSection>
        <Header3 className="font-serif">29. Contact Us</Header3>
        <p>
