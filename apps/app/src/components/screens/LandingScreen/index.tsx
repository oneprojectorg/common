    ...
    <div className="min-h-0 gap-4 pt-8 sm:gap-10 sm:pt-14 container flex grow flex-col">
      ...
      <div className="sm:grid hidden grid-cols-15">
        ...
        <div className="col-span-5">
          <Surface className="gap-6 sm:border sm:border-neutral-gray1 sm:p-6 flex flex-col border-0">
...
const NewOrganizationsList = () => {
  return (
    <Surface className="-mx-8 gap-6 sm:mx-0 sm:border sm:border-neutral-gray1 sm:p-6 flex flex-col border-0">
      ...
      {showPostUpdate ? (
        <>
          <Suspense fallback={<Skeleton className="h-full w-full" />}>
            <Surface className="mb-8 p-0 pt-5 sm:mb-4 sm:border sm:border-neutral-gray1 sm:p-4 border-0">
