...
export const Profile = ({
  ...
  return (
    <>
      ...
      <div className="sm:border-offWhite gap-3 sm:mt-0 sm:min-h-[calc(100vh-3.5rem)] sm:gap-4 sm:border -mt-[3.05rem] flex w-full flex-col border-offWhite border-b-transparent">
