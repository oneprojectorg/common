    ...
    <div className="gap-8 sm:pb-20 relative flex w-full flex-col">
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          about you known as Personal Data (defined further below in this
          Notice). As an entity with international operations, One Project
          provides services to users in different countries, and we process
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          how you may exercise any rights you may have regarding our processing
          of your Personal Data, and how you can contact us if you would like to
          exercise them or if you have any questions or concerns.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          yourself, please note that you are responsible for complying with all
          privacy and data protection laws prior to providing that information
          to One Project (including collecting consent, if required).
        </p>
        <p className="mb-4">
          Please review this Notice carefully. To the extent permitted by law,
          by providing us your Personal Data or otherwise interacting with us,
          you are agreeing to this Notice and consent to the personal data
          processing described in this notice. If you do not agree with our
          policies and practices, it is your choice not to use our Services or
          otherwise engage with us.
        </p>
        <p className="mb-4">
          This Notice is designed with the nonprofit context in mind. We process
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          Personal Data is any information—as electronically or otherwise
          recorded—that can be used to identify a person or that we can link to
          or associate with a specific individual, such as a name, address,
          email address, or telephone number. Personal Data in some countries
          can include information that indirectly identifies a person, even
          absent other identifying information.
        </p>
        <p className="mb-4">
          Personal Data may include information considered sensitive in some
        ...
        <p className="mb-4">
          ...
          and as described in this Notice (unless, as explained above, a
          separate policy or notice governs). In some circumstances, if you do
        ...
        <p className="mb-4">
          ...
          additional detail and information on how we collect, process, and use
          Personal Data and the potential recipients of your Personal Data, now
          and in the preceding 12 months. Some jurisdictions require us to state
          the legal bases for processing your Personal Data, which are the
          legally recognized reasons for processing your Personal Data, but
          please note that not all jurisdictions recognize all legal bases. The
          types of Personal Data we collect and disclose depends on your
          relationship with One Project. Not all of the categories listed in the
          ...
          <table className="border-gray-300 min-w-full border-collapse border">
            <thead>
              <tr className="bg-gray-100">
                <th className="border-gray-300 px-4 py-2 border text-left"></th>
                <th className="border-gray-300 px-4 py-2 border text-left">
            ...
            <tbody>
              <tr>
                <td className="border-gray-300 px-4 py-2 font-semibold border">
                ...
                <td className="border-gray-300 px-4 py-2 border text-center"></td>
                <td className="border-gray-300 px-4 py-2 border text-center">
                  X
                </td>
              </tr>
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          Platform (including user support, feedback, or email correspondence);
          (3) respond to Platform-specific communications we send you, such as
          release updates, Platform newsletters, or surveys; or (4) take part in
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          We may combine information we collect, including Personal Data, with
          Personal Data that we may obtain from third parties. One Project may
          jointly use your Personal Data to provide you with Services requested,
          including joint use with One Project affiliates, as well as third
          parties who assist or partner with us to provide you with the
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          not imply an endorsement with respect to any third party, any website,
          or the products or services provided thereby. You should carefully
          review the privacy policies and practices of other websites and
          services as we cannot control and are not responsible for privacy
          policies, notices, or practices of third party websites, applications,
          and services.
        </p>
      </FormalSection>
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          to protect Personal Data from loss, misuse, alteration, theft,
          unauthorized access, and unauthorized disclosure consistent with legal
          obligations and industry practices. However, as is the case with all
          websites, applications, products, and services, we unfortunately are
          not able to guarantee security for data collected through our
          Services. In addition, it is your responsibility to safeguard any
          passwords, identification or ID numbers, or similar individual
          information associated with your use of the Services.
        </p>
      </FormalSection>
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          and as outlined in this Notice. In some cases, we may be required to
          retain Personal Data for a longer period of time as required by law or
          for other necessary or required purposes. Whenever possible, we aim to
          de-identify or anonymize your Personal Data or otherwise remove some
          or all information that may identify you from records that we may need
          to keep for periods beyond the specified retention period. The
          criteria used to determine our retention periods include: (i) the
          length of time we have an ongoing relationship with you; (ii) whether
          there is a legal obligation to which we are subject that affects the
          length of time we need to keep your Personal Data; and (iii) whether
          retention is determined to be necessary for One Project due to
          limitation periods, litigation, or other legal or regulatory
          obligations. One Project takes reasonable steps to securely dispose of
          Personal Data upon the expiration of retention periods, taking into
          consideration these litigation, legal, or regulatory obligations.
        </p>
      </FormalSection>
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          Personal Data we collect and process may be transferred and maintained
          outside your state, province, country, or other jurisdiction, country,
          or location where the privacy laws may not be as protective as those
          in your location, including the United States. One Project has put in
          place lawful transfer mechanisms and appropriate safeguards, in
          accordance with its legal requirements, to protect your Personal Data.
        </p>
      </FormalSection>
      ...
      <FormalSection>
        ...
        <p className="mb-4">
          ...
          Notice was last updated as the date the Notice became effective or as
          otherwise may be required by law. It is recommended that you
          periodically revisit this Notice to learn of any changes.
        </p>
      </FormalSection>
