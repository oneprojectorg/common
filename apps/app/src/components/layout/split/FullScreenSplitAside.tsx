...
export const FullScreenSplitAside = ({
  ...
  return (
    <aside className="right-0 top-0 lg:sticky lg:z-10 lg:col-span-1 lg:flex lg:min-w-96 lg:bg-teal relative -z-10 hidden size-full h-screen flex-col items-center justify-center bg-gradient text-offWhite">
