...
export const FullScreenSplitAside = ({
  ...
  return (
    <aside className="relative end-0 top-0 -z-10 hidden size-full h-screen flex-col items-center justify-center bg-gradient text-offWhite lg:sticky lg:z-10 lg:col-span-1 lg:flex lg:min-w-96 lg:bg-teal">
      <div className="absolute h-full w-full bg-gradient">
        <img
          src="/topLeft.png"
          alt="Top Left Decoration"
          className="absolute start-0 top-0 z-0"
        />
        <img
          src="/bottomRight.png"
          alt="Bottom Right Decoration"
          className="absolute end-0 bottom-0 z-0"
        />
        <div
