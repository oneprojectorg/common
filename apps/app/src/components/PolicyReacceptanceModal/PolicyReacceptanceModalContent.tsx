...
/**
 * The gate's body, in its own module so `index.tsx` can pull it — and the three
 * legal documents it renders — with `next/dynamic`. The gate mounts in both
 * authed layouts but shows for almost nobody, so keeping this eager put ~2k
 * lines of static policy copy in every authed page's first-paint bundle.
 */
export const PolicyReacceptanceModalContent = () => {
