...
export const LoginPanel = () => {
  ...
  return (
    <div className="sm:block flex items-center justify-center">
      <div className="min-w-xs px-4 py-8 text-neutral-700 xs:w-96 sm:border-0 z-[999999] max-h-full w-auto rounded-md border-offWhite bg-white bg-clip-padding font-sans">
