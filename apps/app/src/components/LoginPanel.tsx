...
export const LoginPanel = () => {
  ...
  return (
    <div className="flex items-center justify-center sm:block">
      <div className="min-w-xs xs:w-96 border-offWhite z-[999999] max-h-full w-auto rounded-md bg-white bg-clip-padding px-4 py-8 font-sans text-neutral-700 sm:border-0">
        <div className="flex flex-col gap-12 sm:gap-8">
          <section className="flex flex-col items-center justify-center gap-2 sm:gap-4">
            ...
            <div className="text-neutral-gray4 px-4 text-center text-sm leading-[130%] sm:text-base">
              {user?.error?.name === 'AuthRetryableFetchError'
          ...
          <section className="flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-8">
                  {!loginSuccess && (
                    <>
                      ...
                      <div className="text-midGray flex w-full items-center justify-center gap-4">
            ...
            <section className="flex flex-col gap-6">
              ...
              login.isError ||
              !!combinedError ? null : (
                <div className="text-midGray flex flex-col items-center justify-center text-center text-xs sm:text-sm">
                  {isSignup ? (
                    <span>
