...
export function ProposalViewLayout({
  ...
  canJoin?: boolean;
  /**
   * Whether the process takes comments. `false` drops the mobile jump button —
   * it targets a comments section that isn't rendered. Defaults to true,
   * matching the process default.
   */
