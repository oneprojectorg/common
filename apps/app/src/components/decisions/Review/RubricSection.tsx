...
/**
 * Locale-formatted zero in the field's currency ("$0.00" in en-US, "0,00 €" in
 * fr-FR) — the empty-state placeholder for a money input, so both the currency
 * and the expected precision are visible before typing.
 */
export function useAmountPlaceholder(currency: string): string {
  const formatMoney = useMoneyFormatter();
