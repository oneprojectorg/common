      ...
      <div className="flex-1 px-6 py-8">
        <div className="mx-auto flex max-w-xl flex-col gap-8">
          <div className="space-y-4">
            {/* Title */}
            <Header1 className="text-title-lg font-serif">
            ...
            <div className="space-y-6">
                ...
                {currentProposal.submittedBy && (
                  <>
                    ...
                    <div className="flex flex-col">
                      <span className="text-neutral-black text-base">
                        {currentProposal.submittedBy.name ||
                          currentProposal.submittedBy.slug}
                      </span>
              ...
              {/* Engagement Stats */}
              <div className="border-neutral-gray1 text-neutral-gray4 flex items-center gap-4 border-b border-t py-4 text-sm">
          ...
          <div className="mt-12" ref={commentsContainerRef}>
            <div className="border-neutral-gray1 border-t pt-8">
              <h3 className="text-neutral-charcoal mb-6 text-lg font-semibold">
                {t('Comments')} ({comments.length})
              </h3>

              {/* Comment Input */}
              <div className="mb-8">
                <Surface className="sm:border-neutral-gray1 border-0 p-0 sm:border sm:p-4">
                  <PostUpdate
                    profileId={currentProposal.profileId || undefined}
