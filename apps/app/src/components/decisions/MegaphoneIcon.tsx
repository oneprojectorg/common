...
// GoMegaphone (GitHub Octicons) path data, rendered as a thin stroke instead
// of a filled silhouette so it visually matches the lucide icons used
// alongside it (LuSettings, LuArrowLeft).
