  ...
  return (
    <div className="p-4 sm:p-8">
      ...
      <p className="max-w-128">
        ...
        irure aliqua velit sint. Officia reprehenderit labore minim eiusmod
        dolore deserunt labore. Enim sit officia tempor consequat sunt duis. Ea
        eiusmod do qui nostrud cupidatat fugiat adipisicing cupidatat nisi
        eiusmod mollit nulla sint. Duis velit officia aliquip nulla
        reprehenderit elit.
      </p>
      <p className="max-w-128">
        Cupidatat pariatur irure et labore quis aliquip ullamco. Laboris
